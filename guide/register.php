...
$guide = new Guide();
$countryCodes = $guide->connect()->prepare("SELECT * FROM country_code ORDER BY countrycode_name ASC");
$countryCodes->execute();
$countryCodes = $countryCodes->fetchAll();

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $result = $guide->registerGuide(
        $_POST['name_first'],
...
<html>
<head>
    <title>Guide Registration - Tour Guide System</title>
</head>
<body>
